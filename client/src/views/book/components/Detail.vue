                  ...
                  <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item prop="fileName" label="文件名称：" :label-width="labelWidth">
                              <el-input v-model="postForm.fileName" placeholder="文件名称" disabled></el-input>
                          </el-form-item>
                      </el-col>
                  </el-row>
                  <el-row>
    ...
    methods: {
        ...
        setData(data){
            const {title, author, publisher, language,
                ...
                fileName, coverPath, filePath, unzipPath, contentsTree } = data
                if (data.cover === '') {
                    this.postForm.cover = 'http://lxy.amusement.com/defaultCover/default.jpg'
                    this.postForm.coverPath = '/defaultCover/default.jpg'
                } else {
                    this.postForm.cover = data.cover
                    this.postForm.coverPath = data.coverPath
                }
